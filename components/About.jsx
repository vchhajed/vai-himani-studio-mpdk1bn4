      ...
      <div className="container about-grid section">
        ...
        <div className="about-img-col">
          <div className="about-img-wrap">
            <Image
              src={about.image || '/products/design-studio.jpeg'}
              alt="Fashion Design Studio & Couture Craftsmanship"
              fill
            ...
            <div className="about-corner-badge">
              <span className="about-badge-num">Award</span>
              <span className="about-badge-label">Winning Designer</span>
            </div>
          </div>
        </div>
      </div>
