...
const heroImages = [
  { src: 'https://source.unsplash.com/1600x900/?business%2Coffice%2Cprofessional&sig=0',             label: 'Custom Design Consultation' },
  { src: 'https://source.unsplash.com/1600x900/?team%2Cmeeting%2Ccorporate&sig=1',                  label: 'Design Team Expertise' },
  { src: 'https://source.unsplash.com/1600x900/?city%2Cbuilding%2Cmodern&sig=2',                     label: 'Couture Craftsmanship' },
  { src: 'https://source.unsplash.com/1600x900/?workspace%2Cclean%2Cbright&sig=3',      label: 'Premium Materials' },
];
      ...
      <div className="container hero-split">
        ...
        <div className="hero-content">
          <div className="hero-eyebrow">
            ...
            <span className="hero-sub-tag">Bespoke Fashion Design</span>
          </div>
        ...
        <div className="hero-visual">
          ...
          <div className="hero-float-badge">
            <span className="hero-float-num">✓</span>
            <span className="hero-float-text">Designer Approved</span>
          </div>
        </div>
      </div>
